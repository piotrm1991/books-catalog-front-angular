...
import { FormBuilderAndServiceProviderService } from 'src/app/util/form.builder.and.service.provider.service';
...
export class StatusTypeListComponent implements AfterViewInit {
  ...
  constructor (
    ...
    private formAndServiceProvider: FormBuilderAndServiceProviderService
  ) {
